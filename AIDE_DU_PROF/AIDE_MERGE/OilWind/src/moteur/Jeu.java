...
public class Jeu {
    ...
    private Timer timer; // Déclaration du timer
...
////    private void placerBarilsAleatoirement(int nb_baril) {
////        
////        int nbBarils = nb_baril; // Nombre de barils à placer
...
////            
////            if (CarteMoteur.getMatrice()[x][y] == 0) { //Case 0 = case vide
...
//        // Création du runner
//        this.runner = new Runner(1, "Runner", 0, 0, 1); // Exemple de valeurs pour le Runner
//        
