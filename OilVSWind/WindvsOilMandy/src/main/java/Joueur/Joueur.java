...
// Classe Jeu contiendra tous les éléments du jeu (décor, objets, avatar, règles, etc.). 
// La classe Jeu doit posséder les méthodes miseAJour et rendu qui seront appelées dans la boucle de jeu ainsi qu’une méthode booléenne estTermine pour savoir si la partie est terminée.

// La classe Banane contient les méthodes rendu et miseAJour.
...
// La classe Jeu un attribut Joueur et les commandes nécessaires dans le constructeur et dans les méthodes rendu et miseAJour